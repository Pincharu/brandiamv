    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          ...
          if (context.screenWidth > 850)
            Obx(() => (model.bags.value != 0 || model.bars.value != 0)
                ? model.refreshPage()
                    ? sideCart(context, model).expand()
                    : sideCart(context, model).expand()
                : const SizedBox())
        ],
      ),
          ...
          Row(
            children: [
              ElevatedButton(
                ...
                onPressed: () {
                  if (model.checkFields()) model.checkout();
                },
...
Widget sideCart(BuildContext context, HomeCore model) {
  return ListView(
    children: [
      20.heightBox,
              ...
              : ListTile(
                  ...
                  leading: (currentProduct.image != null)
                      ...
                      : const SizedBox(
                          ...
                          width: 80,
                          child: ImagePlacer(image: kimageProduct, boxfit: BoxFit.contain)),
                  title: currentProduct.name.text.capitalize.size(16).make(),
                  subtitle: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      "ITEM CODE: ${currentProduct.itemCode}"
                          ...
                          .color(Colors.black54)
                          .make(),
                      Row(mainAxisAlignment: MainAxisAlignment.end, children: [AddProduct(i: i)])
                    ],
                  ),
                ).pOnly(bottom: 4);
        },
